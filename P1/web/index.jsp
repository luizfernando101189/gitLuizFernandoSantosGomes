<%-- 
    Document   : index
    Created on : 4 de out de 2020, 10:15:35
    Author     : Luiz
--%>
...
<html>
    ...
    <head>
        <%
            ArrayList<Disciplina> disciplinaList = (ArrayList) application.getAttribute("disciplinaLost");
    ...
    <body>
        ...
        <h3>Materias Matriculadas:<%=disciplinaList.size()%></h3>
        </div>
    </body>
</html>
